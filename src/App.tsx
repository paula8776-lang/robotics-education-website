...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-gray-900">
      ...
      <section id="docente" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50">
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="text-gray-300 text-lg mb-6 leading-relaxed">
          Este espacio educativo ha sido creado para apoyar el aprendizaje de los estudiantes en las áreas de
          Sistemas Informáticos, Programación, Robótica, Computación Física e Inteligencia Artificial.
        </p>

        <p className="text-gray-300 text-lg mb-6 leading-relaxed">
          Aquí los estudiantes encontrarán guías, videos, recursos de clase y proyectos prácticos que fortalecen
          el pensamiento lógico, la creatividad, la solución de problemas y el uso responsable de la tecnología.
        </p>

        <div className="bg-slate-900/70 border border-cyan-500/30 rounded-xl p-6">
          <h3 className="text-xl font-bold text-cyan-400 mb-3">
            Paula Marcela Rivera Cruz
          </h3>
          <p className="text-gray-300">
            Docente de Sistemas Informáticos, Robótica, Programación e Inteligencia Artificial.
          </p>
        </div>
      </div>

      <div className="bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-2xl p-8 border border-cyan-500/30 shadow-lg shadow-cyan-500/20">
        ...
        <ul className="space-y-4 text-gray-300">
          <li className="flex items-start gap-2">
            ...
            <span>Organizar materiales de apoyo para las clases.</span>
          </li>
          <li className="flex items-start gap-2">
            <ChevronRight className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
            <span>Facilitar el acceso a guías, videos y proyectos.</span>
          </li>
          <li className="flex items-start gap-2">
            <ChevronRight className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
            <span>Fortalecer el aprendizaje práctico en tecnología.</span>
          </li>
          <li className="flex items-start gap-2">
            <ChevronRight className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
            <span>Promover el desarrollo de soluciones tecnológicas escolares.</span>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div>
        ...
        <ul className="space-y-3 text-gray-300 mb-6">
          <li className="flex items-start gap-2">
            ...
            <span><strong>Algoritmos y lógica:</strong> análisis de problemas, diagramas de flujo y pseudocódigo.</span>
          </li>
